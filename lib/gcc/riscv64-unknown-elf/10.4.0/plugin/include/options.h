...
enum opt_code
{
  ...
  OPT_mldi = 1638,                           /* -mldi */
  OPT_mldr = 1639,                           /* -mldr */
  OPT_mload_merging = 1640,                  /* -mload-merging */
  OPT_mmove_loop_vsetvl = 1641,              /* -mmove-loop-vsetvl */
  OPT_mmula = 1642,                          /* -mmula */
  OPT_mplt = 1643,                           /* -mplt */
  ...
  OPT_pie = 1681,                            /* -pie */
  OPT_pipe = 1682,                           /* -pipe */
  OPT_print_file_name_ = 1683,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1684,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1685,          /* -print-multi-directory */
  OPT_print_multi_lib = 1686,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1687,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1688,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1689,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1690,               /* -print-prog-name= */
  OPT_print_search_dirs = 1691,              /* -print-search-dirs */
  OPT_print_sysroot = 1692,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1693,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1694,                    /* -print-value */
  /* OPT_pthread = 1695, */                  /* -pthread */
  OPT_quiet = 1696,                          /* -quiet */
  OPT_r = 1697,                              /* -r */
  OPT_remap = 1698,                          /* -remap */
  OPT_reverse_sort = 1699,                   /* -reverse-sort */
  OPT_s = 1700,                              /* -s */
  OPT_save_temps = 1701,                     /* -save-temps */
  OPT_save_temps_ = 1702,                    /* -save-temps= */
  OPT_shared = 1703,                         /* -shared */
  OPT_shared_libgcc = 1704,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1705,               /* -shared-libphobos */
  OPT_size_sort = 1706,                      /* -size-sort */
  /* OPT_specs = 1707, */                    /* -specs */
  OPT_specs_ = 1708,                         /* -specs= */
  OPT_static = 1709,                         /* -static */
  OPT_static_libasan = 1710,                 /* -static-libasan */
  OPT_static_libgcc = 1711,                  /* -static-libgcc */
  OPT_static_libgfortran = 1712,             /* -static-libgfortran */
  OPT_static_libgo = 1713,                   /* -static-libgo */
  OPT_static_liblsan = 1714,                 /* -static-liblsan */
  OPT_static_libmpx = 1715,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1716,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1717,               /* -static-libphobos */
  OPT_static_libstdc__ = 1718,               /* -static-libstdc++ */
  OPT_static_libtsan = 1719,                 /* -static-libtsan */
  OPT_static_libubsan = 1720,                /* -static-libubsan */
  OPT_static_pie = 1721,                     /* -static-pie */
  /* OPT_std_c__03 = 1722, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1723, */                /* -std=c++0x */
  OPT_std_c__11 = 1724,                      /* -std=c++11 */
  OPT_std_c__14 = 1725,                      /* -std=c++14 */
  OPT_std_c__17 = 1726,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1727, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1728, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1729, */                /* -std=c++20 */
  OPT_std_c__2a = 1730,                      /* -std=c++2a */
  OPT_std_c__98 = 1731,                      /* -std=c++98 */
  OPT_std_c11 = 1732,                        /* -std=c11 */
  OPT_std_c17 = 1733,                        /* -std=c17 */
  /* OPT_std_c18 = 1734, */                  /* -std=c18 */
  /* OPT_std_c1x = 1735, */                  /* -std=c1x */
  OPT_std_c2x = 1736,                        /* -std=c2x */
  /* OPT_std_c89 = 1737, */                  /* -std=c89 */
  OPT_std_c90 = 1738,                        /* -std=c90 */
  OPT_std_c99 = 1739,                        /* -std=c99 */
  /* OPT_std_c9x = 1740, */                  /* -std=c9x */
  OPT_std_f2003 = 1741,                      /* -std=f2003 */
  OPT_std_f2008 = 1742,                      /* -std=f2008 */
  OPT_std_f2008ts = 1743,                    /* -std=f2008ts */
  OPT_std_f2018 = 1744,                      /* -std=f2018 */
  OPT_std_f95 = 1745,                        /* -std=f95 */
  OPT_std_gnu = 1746,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1747, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1748, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1749,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1750,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1751,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1752, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1753, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1754, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1755,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1756,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1757,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1758,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1759, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1760, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1761,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1762, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1763,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1764,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1765, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1766, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1767,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1768, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1769, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1770, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1771, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1772, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1773,                     /* -std=legacy */
  OPT_symbol_ = 1774,                        /* -symbol= */
  OPT_symbolic = 1775,                       /* -symbolic */
  OPT_t = 1776,                              /* -t */
  OPT_time = 1777,                           /* -time */
  OPT_time_ = 1778,                          /* -time= */
  OPT_traditional = 1779,                    /* -traditional */
  OPT_traditional_cpp = 1780,                /* -traditional-cpp */
  OPT_tree_stats = 1781,                     /* -tree-stats */
  OPT_trigraphs = 1782,                      /* -trigraphs */
  OPT_type_stats = 1783,                     /* -type-stats */
  OPT_u = 1784,                              /* -u */
  OPT_undef = 1785,                          /* -undef */
  OPT_v = 1786,                              /* -v */
  OPT_version = 1787,                        /* -version */
  OPT_w = 1788,                              /* -w */
  OPT_wrapper = 1789,                        /* -wrapper */
  OPT_x = 1790,                              /* -x */
  OPT_z = 1791,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
